...
<b>${order.customer.streetAddress}</b>
<br />
...
<br />
<a
	href="flow.htm?_flowExecutionKey=${flowExecutionKey}&_eventId=continue">Place
	Order</a>
|
...
<h3>Pizzas:</h3>
<small> <a
	href="flow.htm?_flowExecutionKey=${flowExecutionKey}&_eventId=addPizza">Add
		Pizza</a>
</small>
<br>
<c:forEach items="${order.pizzas}" var="pizza">
	<li>${pizza.size}: <c:forEach items="${pizza.toppings}"
			var="topping">
      ${topping}, 
  </c:forEach>
	</li>
