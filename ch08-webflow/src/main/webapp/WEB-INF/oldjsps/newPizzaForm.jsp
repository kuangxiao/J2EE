...
<form:form action="flow.htm" commandName="order.customer">
	...
	<input type="checkbox" value="CANADIAN_BACON" name="toppings">Canadian Bacon<br />
	<input type="checkbox" value="PINEAPPLE" name="toppings">Pineapple<br />
	<input type="checkbox" value="GREEN_PEPPER" name="toppings">Green Pepper<br />
	<input type="checkbox" value="ONION" name="toppings">Onion<br />
	<input type="checkbox" value="JALAPENO" name="toppings">Jalapeno<br />
	<input type="checkbox" value="TOMATO" name="toppings">Tomato<br />
	<input type="checkbox" value="EXTRA_CHEESE" name="toppings">Extra Cheese<br />
