...
public class AuctionConstant {	
	...
	//get XHR http://dbditem.jd.com/json/current/englishquery?paimaiId=12863687&skuId=0&t=265688&start=0&end=9
	public static final String URL_BID_RECORDS = "http://dbditem.jd.com/json/current/englishquery";		
	
	//get XHR http://dbditem.jd.com/services/bid.action?t=331673&paimaiId=12863864&price=104&proxyFlag=0&bidSource=0
	public static final String URL_INCRE_PRICE = "http://dbditem.jd.com/services/bid.action";		
	
	//账户信息
	public static final String LOGIN_NAME = "redzero";
	public static final String LOGIN_PWD = "eBao2004";		
	
	// 投标主线程休眠间隔
	public static long  BIDDING_SLEEP_TIME = 198L; 
