...
public class HttpClientUtil {
	...
	public static String httpPost(String url, String data, String contentType) throws Exception {
		...
		logger.info("the result from HttpClientUtil:result=" + (null != sb.toString() ? sb.toString().trim() : null));
		long endTime = System.currentTimeMillis();
		logger.info("结束调用：HttpClientUtil的httpPostWithJSON方法" + " [" + Long.toString(endTime - startTime) + "]");
