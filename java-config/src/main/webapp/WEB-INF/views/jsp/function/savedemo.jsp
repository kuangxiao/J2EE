...
<script src="${_contextPath}/static/js/jquery-1.11.0.min.js"></script>
</head>
<body>

	<form method="post" id="loginForm" action="${_contextPath}/demo/save">
		<div class="main">
			<div class="login">
				<ul>
					<li><span>id:</span> ${demo.id}</li>
					<li><span>name:</span> <input type="text" name="name"
						id="name" value="${demo.name}" /></li>
					<li><span>age:</span> <input type="text" name="age" id="age"
						value="${demo.age}" /></li>
